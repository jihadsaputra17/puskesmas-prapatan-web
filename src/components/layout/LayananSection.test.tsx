...
describe("LayananSection", () => {
  it("sanitizes stored rich service descriptions", async () => {
    mocks.getLayanan.mockResolvedValue([{ id: "service-1", icon: "🏥", nama_poli: "Umum", deskripsi: '<img src="javascript:alert(1)" onerror="alert(1)"><svg><script>alert(1)</script></svg><p>Aman</p>' }]);
