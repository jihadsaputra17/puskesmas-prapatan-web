...
export default async function ManajemenLayananPage() {
  const session = await getServerSession(authOptions); if (session?.user?.role !== "superadmin") redirect("/admin");
